...
class GenericDataFormatter(abc.ABC):
    ...
    def _get_input_columns(self):
        ...
        return [
            tup[0] for tup in self.get_column_definition() if tup[2] not in {InputTypes.ID, InputTypes.TIME}
        ]
    ...
    def _get_tft_input_indices(self):
        ...
        def _extract_tuples_from_data_type(data_type, defn):
            return [
                tup for tup in defn if tup[1] == data_type and tup[2] not in {InputTypes.ID, InputTypes.TIME}
            ]
